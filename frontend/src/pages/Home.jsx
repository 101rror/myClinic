...
import { getPatients, getStats, addPatient as apiAddPatient, markVisited as apiMarkVisited } from "../api/patients";
...
export default function Home() {
    ...
    const markVisitedOptimistic = async (id) => {
        ...
        setStats((s) => ({
            ...
            totalEmergency: patient.priority === "Emergency" ? Math.max((s.totalEmergency || 1) - 1, 0) : (s.totalEmergency || 0),
        ...
        try {
            ...
            setStats((s) => ({
                ...
                totalEmergency: patient.priority === "Emergency" ? (s.totalEmergency || 0) + 1 : (s.totalEmergency || 0),
